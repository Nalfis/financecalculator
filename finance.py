...
parser.add_argument("-fv", "--futura_value", action='store_true', required=False, help="Calculate Future Value")
parser.add_argument("-pv", "--presente_value", action='store_true', required=False, help="Calculate Present Value")
